...
function Step1SetUp({ onStart }) {
    ...
    return (
        ...
        >
            <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-3 overflow-hidden">
                <motion.div
                ...
                {/* right box */}
                <motion.div className="p-12 flex flex-col justify-center">
                    ...
                    <div className="space-y-6">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Enter Role"
                                className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-400 outline-none transition"
                        ...
                        <select value={mode}
                            ...
                            className="w-full py-4 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition"
                        >
        ...
        space-y-4 max-h-[280px] overflow-y-auto scrollbar-hide">
    ...
    duration-300 shadow-md">
                ...
                <motion.div
                    ...
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ duration: 0.7 }}
                    className="relative hidden md:flex items-center justify-center bg-white p-12">
                    <div className="absolute inset-0 bg-green-50 opacity-30"></div>
                    <div className="relative z-10 text-center">
                        <div className="w-64 h-64 bg-green-100 rounded-full flex items-center justify-center mb-8 mx-auto shadow-inner">
                            <FaMicrophoneAlt className="text-8xl text-green-600 animate-pulse" />
                        </div>
                        <h3 className="text-2xl font-bold text-gray-800 mb-4">Ready to Shine?</h3>
                        <p className="text-gray-600">Your AI interviewer is waiting to help you practice and improve.</p>
                    </div>
                </motion.div>
            </div>
